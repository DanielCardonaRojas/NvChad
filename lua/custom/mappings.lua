...
M.neotest = function()
  map('n', '<leader>dT', ':lua require("neotest").run.run(vim.fn.expand("%")) <CR>')
  map('n', '<leader>dt', ':lua require("neotest").run.run() <CR>')
  map('n', '<leader>ds', ':lua require("neotest").summary.toggle() <CR>')
end
